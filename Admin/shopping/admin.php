...
if(isset($_POST['update_product'])){
   ...
   $update_p_num_items = $_POST['update_p_num_items'];
   ...
   num_items = '$update_p_num_items', weight = '$update_p_weight', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
...
<div class="container">
   ...
   <!-- <div class="header_info">
      <a href="">
         <div class="sq">
            <img src='.../images/afrigas.jpg'>
            <p>Number of full gas<br>cylinders</p>
         </div>
      </a>
      ...
      <a href="">
         <div class="sq">
            ...
            <p>Number of empty gas<br>cylinders</p>
         </div>
      </a>
...
<section class="display-product-table">
   ...
   <table>
      ...
      <tbody>
         ...
         ?>
<!-- "C:\wamp64\www\Gas manage\uploaded_img" -->
         <tr>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" required name="update_p_num_items" value="<?php echo $fetch_edit['num_items']; ?>">
      <input type="text" class="box" required name="update_p_weight" value="<?php echo $fetch_edit['weight']; ?>">
